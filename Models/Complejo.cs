...

{
    ...
    public Complejo()
    {
        ...
        List<string> fotosRefugio = new List<string> { "refugio_01.jpg", "refugio_02.jpg", "refugio_interior.jpg" };
        ...
        List<string> fotosSoñada = new List<string> { "sonada_principal.jpg", "sonada_living.jpg", "sonada_jardin.jpg" };
        ...
        List<string> fotosAltos = new List<string> { "altos_01.jpg", "altos_pileta.jpg", "altos_vista.jpg", "altos_noche.jpg" };
